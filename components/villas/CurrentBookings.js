        ...
        <>
            ...
            >
                <div className='px-[25px]'>
                    <h1 className='font-medium text-[20px] text-[#2E3039]'>Active Bookings</h1>
                </div>
                    ...
                    <table className='table-fixed w-[750px] md:w-full'>
                        ...
                        <tbody>
                            {Array.isArray(data) && data.map((item, index) => {
                                return (
                                    <tr
                                        className='border-b last:border-b-0 border-[#EFF3F9]'
                                        key={index + ''}
                                    >
                                        <td className=' pl-[36px] py-[24px] text-[#54617A]  text-sm font-roboto '>{item?.villa_name}</td>
                                        <td className='  py-[24px] text-[#54617A] font-roboto text-sm'>{item?.booking_id}</td>
